...
- [Отчёт Word по контрольной №1](reports/Отчет_КР1_Инструменты_Девопс_Изосимов_МИ.docx) — 12 страниц, 8 встроенных скриншотов.
- [Исходные скриншоты](reports/screenshots) и [журналы выполненных команд](reports/evidence).
- [Заметки о VS Code и CLI](ide_notes.md).
- [Описание пет-проекта и открытый PR №7](https://github.com/blur3773/devops-course-2026/pull/7).

Основное задание из вложения контрольной выполнено. В расширенной методичке остаётся парное ревью: независимый участник должен оставить замечание, после исправления — одобрение. PR №7 сохранён открытым. Локальная ветка `practice/rebase-playground` подготовлена для демонстрации и намеренно не опубликована согласно методичке.
